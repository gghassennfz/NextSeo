      ...
      <div className="relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
          ...
          >
            ...
            >
              Get comprehensive SEO analysis with actionable insights, beautiful reports, and expert recommendations. 
              Perfect for agencies, marketers, and website owners.
            </motion.p>
            ...
            >
              <h3 className="text-lg font-semibold text-gray-900 mb-6">
                We analyze 50+ SEO factors including:
              </h3>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3 max-w-4xl mx-auto">
                {checkpoints.map((checkpoint, index) => (
                  <motion.div
                    ...
                    className="flex items-center space-x-2 text-sm text-gray-700 bg-white/50 rounded-lg p-3"
                  >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Get professional-grade SEO insights that help you outrank competitors and grow your online presence.
            </p>
          </motion.div>
